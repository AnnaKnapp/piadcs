//This example reads the output of the ADC1 on the ADS126x. If you dont want it to save the data in your current directory please make sure to change the filepath before running
package main
